...
// Public key hash.
// IMPORTANT: resulting address depends on whether `publicKeyCompressed` is YES or NO.
@property(nonatomic, readonly) TBPublicKeyAddress* address;
@property(nonatomic, readonly) BTCPublicKeyAddress* btcAddress;
@property(nonatomic, readonly) BTCPublicKeyAddressTestnet* btcTestAddress;
